...
static int wxMSWConvertPageSetupToNative(int mm, DWORD units)
{
...
static int wxMSWConvertPageSetupFromNative(int value, DWORD units)
{
    if ( units == PSD_INTHOUSANDTHSOFINCHES )
...
bool wxWindowsPageSetupDialog::ConvertToNative( wxPageSetupDialogData &data )
{
    ...
    pd->ptPaperSize.x =
        wxMSWConvertPageSetupToNative(data.GetPaperSize().x, pageSetupUnits);
    pd->ptPaperSize.y =
        wxMSWConvertPageSetupToNative(data.GetPaperSize().y, pageSetupUnits);

    pd->rtMinMargin.left =
        wxMSWConvertPageSetupToNative(data.GetMinMarginTopLeft().x, pageSetupUnits);
    pd->rtMinMargin.top =
        wxMSWConvertPageSetupToNative(data.GetMinMarginTopLeft().y, pageSetupUnits);
    pd->rtMinMargin.right =
        wxMSWConvertPageSetupToNative(data.GetMinMarginBottomRight().x, pageSetupUnits);
    pd->rtMinMargin.bottom =
        wxMSWConvertPageSetupToNative(data.GetMinMarginBottomRight().y, pageSetupUnits);

    pd->rtMargin.left =
        wxMSWConvertPageSetupToNative(data.GetMarginTopLeft().x, pageSetupUnits);
    pd->rtMargin.top =
        wxMSWConvertPageSetupToNative(data.GetMarginTopLeft().y, pageSetupUnits);
    pd->rtMargin.right =
        wxMSWConvertPageSetupToNative(data.GetMarginBottomRight().x, pageSetupUnits);
    pd->rtMargin.bottom =
        wxMSWConvertPageSetupToNative(data.GetMarginBottomRight().y, pageSetupUnits);
...
bool wxWindowsPageSetupDialog::ConvertFromNative( wxPageSetupDialogData &data )
{
    ...
    if ( data.GetPrintData().GetOrientation() == wxLANDSCAPE )
        data.SetPaperSize(wxSize(
            wxMSWConvertPageSetupFromNative(pd->ptPaperSize.y, pageSetupUnits),
            wxMSWConvertPageSetupFromNative(pd->ptPaperSize.x, pageSetupUnits)));
    else
        data.SetPaperSize(wxSize(
            wxMSWConvertPageSetupFromNative(pd->ptPaperSize.x, pageSetupUnits),
            wxMSWConvertPageSetupFromNative(pd->ptPaperSize.y, pageSetupUnits)));
    ...
    data.SetMinMarginTopLeft(wxPoint(
        wxMSWConvertPageSetupFromNative(pd->rtMinMargin.left, pageSetupUnits),
        wxMSWConvertPageSetupFromNative(pd->rtMinMargin.top, pageSetupUnits)));
    data.SetMinMarginBottomRight(wxPoint(
        wxMSWConvertPageSetupFromNative(pd->rtMinMargin.right, pageSetupUnits),
        wxMSWConvertPageSetupFromNative(pd->rtMinMargin.bottom, pageSetupUnits)));

    data.SetMarginTopLeft(wxPoint(
        wxMSWConvertPageSetupFromNative(pd->rtMargin.left, pageSetupUnits),
        wxMSWConvertPageSetupFromNative(pd->rtMargin.top, pageSetupUnits)));
    data.SetMarginBottomRight(wxPoint(
        wxMSWConvertPageSetupFromNative(pd->rtMargin.right, pageSetupUnits),
        wxMSWConvertPageSetupFromNative(pd->rtMargin.bottom, pageSetupUnits)));
